...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)("https://json-server-rest-api.shvetsviktor89.workers.dev/images").then(data => {
    data.forEach(({
      url,
      altimg,
      title,
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2026-01-01');
